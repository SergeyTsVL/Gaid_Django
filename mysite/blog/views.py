...
def post_list(request):
    ...
    try:
        ...
        posts = paginator.page(1)  #сли страница не является целым числом возвращаем первую страницу
    except EmptyPage:
        posts = paginator.page(paginator.num_pages)
        #Есло номенр страници больше чем страниц возвращаем последнюю страницу
